...
- [ ] M6-phase-4 Sparse effectively unbounded coordinates with stable transforms and no persisted page edge.
- [ ] M6-phase-5 Native trackpad two-finger pan and pinch zoom, centered around the gesture focal point.
- [ ] M6-phase-6 Mouse wheel pan, modifier-wheel zoom, middle-button drag pan, and keyboard pan/zoom centered on accessibility focus.
