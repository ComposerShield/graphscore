...
- [x] M5-phase-37 Range operations also include delete and diatonic/chromatic transpose while preserving valid rhythm.
...
- [x] M5-phase-39 Dynamics use project-wide editable velocity defaults; hairpins interpolate note-on velocities.
- [x] M5-phase-40 Slurs create legato overlap unless an explicit articulation overrides it.
- [x] M5-phase-41 Articulations affect documented note velocity and/or duration.
- [x] M5-phase-42 Pedal spans generate the explicit MIDI CC64 exception.
...
- [x] M5-phase-49 A composer can copy a complete measure to another measure and copy a pointer-dragged partial range to another valid musical position on the same or different compatible staves.
...
- [x] M5-phase-55 Editing a representative 64-track, 64-measure node remains responsive when only a small visible region changes.
