...
class AddGraceGroupCommand : public Command {
 public:
  AddGraceGroupCommand(NodeId node_id, TrackId track_id, StaveId stave_id,
                       Voice voice, GraceGroup grace_group)
      : node_id_(node_id),
        track_id_(track_id),
        stave_id_(stave_id),
        voice_(voice),
        grace_group_(std::move(grace_group)) {}
