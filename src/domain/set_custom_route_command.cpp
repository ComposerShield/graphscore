...
Result SetCustomRouteCommand::execute(Project& project) noexcept {
...
Result SetCustomRouteCommand::undo(Project& project) noexcept {
...
Result SetCustomRouteCommand::redo(Project& project) noexcept {
