...
Result RemoveDynamicCommand::execute(Project& project) noexcept {
  ...
  try {
    ...
    Result result = candidate.remove_dynamic(marking_id_);
    if (!result.ok())
      return result;
...
Result RemoveDynamicCommand::undo(Project& project) noexcept {
...
Result RemoveDynamicCommand::redo(Project& project) noexcept {
...
Result RemoveDynamicCommand::compensate_undo(Project& project) noexcept {
...
Result RemoveDynamicCommand::compensate_redo(Project& project) noexcept {
